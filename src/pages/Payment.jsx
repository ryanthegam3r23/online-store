      ...
      <div className="flex-row">
        <div className="column">
          ...
          <div className="flex-row">
            ...
            <div className="input-box"><span>ZIP</span><input type="text" placeholder="12345"/></div>
          </div>
        </div>
        <div className="column">
          <h3>Payment</h3>
          <div className="input-box"><span>Name on Card</span><input type="text" placeholder="Jane Doe"/></div>
          <div className="input-box"><span>Card Number</span><input type="text" placeholder="1111 2222 3333 4444"/></div>
          <div className="flex-row">
            <div className="input-box"><span>Exp Month</span><input type="text" placeholder="MM"/></div>
            <div className="input-box"><span>Exp Year</span><input type="text" placeholder="YYYY"/></div>
            <div className="input-box"><span>CVV</span><input type="text" placeholder="123"/></div>
          </div>
        </div>
      </div>
